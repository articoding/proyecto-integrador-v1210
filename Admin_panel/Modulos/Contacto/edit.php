...
<?php include("../../Templates/header2.php"); ?>
    ...
    <form action="" method="post">
            ...
            <input type="text" class="form-control" name="comment" value="<?php echo $comment; ?>" placeholder="Ingresa tu Comentario">
            <label for="">Fecha de registro</label>
            <input type="date" class="form-control" name="fecharegistro" value="<?php echo $fecharegistro; ?>" placeholder="Ingresa tu fecha de registro" >
        </div>
